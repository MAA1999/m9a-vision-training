...
if __name__ == '__main__':
    ...
    results = model.train(
        ...
        # 防止过拟合
        patience=80,        # 增加耐心，给小样本类别更多时间
        
        # 数据增强（针对小样本加强）
        hsv_h=0.02,          # 稍微增加色相变化，增加多样性
        hsv_s=0.5,           # 增加饱和度变化
        hsv_v=0.5,           # 增加亮度变化
        degrees=0,           # 不旋转
        ...
        # 损失权重（提高分类损失权重，帮助区分 Message/TreasureLand）
